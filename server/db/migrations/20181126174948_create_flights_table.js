...
exports.up = function (knex, Promise) {
  return knex.schema.createTable('flights', (table) => {
    ...
    table.string('departure_date', 100).notNullable();
    table.string('departure_time', 100).notNullable();
    table.string('arrival_date', 100).notNullable();
    table.string('arrival_time', 100).notNullable();
